...
export function ThemePicker({ initialTheme = "console" }: { initialTheme?: LaylineTheme }) {
  ...
  const choose = (next: LaylineTheme) => {
    ...
    document.cookie = `${THEME_STORAGE_KEY}=${encodeURIComponent(next)}; Path=/prototype/layline/races; Max-Age=31536000; SameSite=Lax`;
  };
...
export function RaceWorkspace({
  ...
  useEffect(() => {
    ...
    document.cookie = `${WORKSPACE_COOKIE_KEY}=${encodeURIComponent(value)}; Path=/prototype/layline/races; Max-Age=31536000; SameSite=Lax`;
