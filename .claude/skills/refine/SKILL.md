---
description: Iterative critique-and-refine loop for an existing page or screen. Screenshot, name defects, fix, re-screenshot until verifiably better. Use when the user says /refine, asks to critique or de-slop a page, or polish a design.
---
